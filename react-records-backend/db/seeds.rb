...
# album3 = Album.create(title: "Enter The Wu-Tang (36 Chambers)", artist: "Wu-Tang Clan", genre: "Hip Hop", condition: "near-mint", description: "Repressing, 180 gram, 12 inch vinyl ", price: 70, category_id: 1)
